...
if ~isfield(options,'subcycHRF'), options.subcycHRF=[Inf 1]; end % until subcycHRF(1) it will estimate the HRF at all iterations,
...
if ~isfield(options,'beta'), options.beta = 1; end; % scaling factor on the prior covariance for the HRF parameters
